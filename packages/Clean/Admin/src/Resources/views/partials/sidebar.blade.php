                ...
                <ul role="list" class="-mx-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.clean.clients.index') }}" 
                           class="{{ request()->routeIs('admin.clean.clients*') ? 'bg-emerald-700 text-white' : 'text-emerald-200 hover:text-white hover:bg-emerald-700' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                            </svg>
                            Clientes
                            <span class="ml-auto w-9 min-w-max whitespace-nowrap rounded-full bg-white px-2.5 py-0.5 text-center text-xs font-medium text-emerald-600 ring-1 ring-inset ring-emerald-200">
                                {{ \Clean\Core\Models\CleanClient::count() }}
                            </span>
                        </a>
                    </li>
